    ...
    try {
      ...
      if (libraryItem.isSample) {
        ...
        try {
          ...
          if (filename) {
            const url = `${process.env.PUBLIC_URL}/samples/${filename}`;
            ...
            console.log('✅ Sample PDF fetched:', blob.size, 'bytes');
          ...
          throw new Error(`Failed to load sample PDF: ${sampleError.message}`);
        }
      }
